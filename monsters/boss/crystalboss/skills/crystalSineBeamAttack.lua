...
function crystalSineBeamAttack.enteringState(stateData)
  ...
  animator.setAnimationState("thirdBeams", "windup")
...
function crystalSineBeamAttack.update(dt, stateData)
  ...
  if stateData.timer > 0 then
    ...
    if stateData.timer < 0 then
	  ...
	  animator.setAnimationState("thirdBeams", "winddown")
...
function crystalSineBeamAttack.leavingState(stateData)
  ...
  animator.setAnimationState("thirdBeams", "idle")
...
function crystalSineBeamAttack.rotateBeams(angle, instant)
  ...
  --Beam 2
  animator.rotateGroup("beam2", angle + math.pi * 0.25, instant)
  crystalSineBeamAttack.setBeamLightPosition("beam2", angle + math.pi * 0.25)

  --Beam 3
  animator.rotateGroup("beam3", angle + math.pi * 0.50, instant)
  crystalSineBeamAttack.setBeamLightPosition("beam3", angle + math.pi)

  --Beam 4
  animator.rotateGroup("beam4", angle + math.pi * 0.75, instant)
  crystalSineBeamAttack.setBeamLightPosition("beam4", angle + math.pi * 0.75)
  
  --Beam5
  animator.rotateGroup("beam5", angle + math.pi, instant)
  crystalSineBeamAttack.setBeamLightPosition("beam5", angle + math.pi )
  
  --Beam6
  animator.rotateGroup("beam6", angle + math.pi * 1.25, instant)
  crystalSineBeamAttack.setBeamLightPosition("beam6", angle + math.pi * 1.25)
  
  --Beam7
  animator.rotateGroup("beam7", angle + math.pi * 1.50, instant)
  crystalSineBeamAttack.setBeamLightPosition("beam6", angle + math.pi * 1.5)
  
  --Beam8
  animator.rotateGroup("beam8", angle + math.pi * 1.75, instant)
  crystalSineBeamAttack.setBeamLightPosition("beam6", angle + math.pi * 1.75)
end

function crystalSineBeamAttack.spawnProjectiles(angle, power)
  for x = 0, 7 do
    local newAngle = angle + math.pi * x * 0.25
...
function crystalSineBeamAttack.setBeamLightsActive(active)
  ...
  animator.setLightActive("beam5", active)
  animator.setLightActive("beam5-2", active)
  animator.setLightActive("beam6", active)
  animator.setLightActive("beam6-2", active)
