...
function GunFire:fireProjectile(projectileType, projectileParams, inaccuracy, firePosition, projectileCount)
  ...
  if self.roll < self.critChance then
    ...
    params.power = self:damagePerShot() * self.critMultiplier * (self.buttDamageMult or 1) * (self.middleDamageMult or 1) * (self.barrelDamageMult or 1) --could do better by getting the augment types and their multiplier but oh well
  else
    local params = sb.jsonMerge(self.projectileParameters, projectileParams or {})
